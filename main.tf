...
resource "azurerm_app_service" "main" {
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      use_32_bit_worker_process = var.use_32_bit_worker_process == "Free" || var.use_32_bit_worker_process == "Shared" ? true : (lookup(site_config.value, "use_32_bit_worker_process", null))
