...
resource "azurerm_app_service" "main" {
  ...
  dynamic "site_config" {
    ...
    content {
      ...
      use_32_bit_worker_process = lookup(site_config.value, "use_32_bit_worker_process", null) == "Free" || lookup(site_config.value, "use_32_bit_worker_process", null) == "Shared" ? true : (lookup(site_config.value, "use_32_bit_worker_process", null))
